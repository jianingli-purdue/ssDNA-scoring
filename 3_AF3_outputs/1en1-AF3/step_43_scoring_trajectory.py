...
for ts in u.trajectory:
    ...
    molecules = u.select_atoms('resname D* and not (index 0 1 2) and not name H*')
...
for frame_ndx in range(len(u.trajectory)):
    frame_name = './reference_from_pdb/dna_0'+'_'+str(frame_ndx)+'.gro'
    print(frame_name)
    ...
    for ts in u1.trajectory:
        ...
        print("tag_P",len(tag_P))
        print("ref_P",len(ref_P))
